...
export const headingTitle = css`
    ...
    @media (min-width: 768px) {letter-spacing: -0.0625rem;}
`;
...
export const headingLargeSmall = css`
    ...
    color: ${({ theme }) => theme.colors.textPrimary};
    transition: color 400ms ease-in-out;
    @media (min-width: 768px) {letter-spacing: -0.03125rem}
`;
...
export const headingSmall = css`
    ...
    @media (min-width: 768px) {letter-spacing: -0.05rem;line-height: 1.5;}
`;
