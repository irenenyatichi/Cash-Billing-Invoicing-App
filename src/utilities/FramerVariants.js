/* Variants found in FormController*/
export const FormControllerVariants = {
    ...
    form: {
        hidden: {x: '-100vw',},
        visible: {x: 0,transition: { type: 'spring', duration: 1, bounce: 0.2 },},
...
/* Variants found in Modal*/
export const modalVariants = {
    modal: {
        hidden: { opacity: 0,},
        visible: {opacity: 1,transition: { duration: 0.3 },}, exit: {opacity: 0,},
    },

    container: {
        hidden: {
            scale: 0},
            visible: {scale: [0, 1.1, 1],transition: { duration: 0.5, delay: 0.1 },},
    },
