    ...
    return(
        <Fieldset>
            ...
            <Wrapper>
                {items.map((item, index) => (
                    <InputsGroup key={index}>
                        ...
                        >
                            ItemName
                            {errors[index]?.name && (
                                <Error>Field Cannot Be Empty!!! Enter a Value.</Error>
                            )}
                        </Label>
                        <Input
                            type="text"
                        ...
                        <InputWrapper>
                        <Label $srOnly={index > 0 && isDesktop}>Total</Label>
                        </InputWrapper>
                        <Delete
                            type="button"
                ...
                <Button type="button" $secondary onClick={handleItemsAdd}>Add New Item</Button>
            </Wrapper>
        </Fieldset>
    );
};
